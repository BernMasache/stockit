    ...
    render() {
        return (
            <div>
                ...
                <Collections collections={this.state.collections} create={this.create} delete={this.delete} update={this.update} collectionsConfiguration={this.state.collectionsConfiguration} />
