                                                            ...
                                                            <Form>
                                                                <div className='space-y-4'  >
                                                                    <div>
                                                                        <div >
                                                                            <label
                                                                                className="block text-sm font-medium text-gray-700 capitalize" htmlFor="date-collected">Date collected</label>
                                                                            <Field
                                                                       ...
                                                                       block
                                                                        ...
                                                                        border-gray-300
                                                                        rounded-md
                                                                        ${touched.dateCollected && errors.dateCollected ? "is-invalid  focus:ring-red-500 focus:border-red-500 " : "focus:ring-green-500 focus:border-gray-500"}`} />
                                                                            <ErrorMessage
                                                                                component="span"
                                                                                name="dateCollected"
                                                                        ...
                                                                        <div className="">
                                                                            <div className="col-span-6 sm:col-span-3">
                                                                                <label
                                                                                    className="block text-sm font-medium text-gray-700 capitalize" htmlFor="collection"> collection</label>
                                                                                <Field
                                                                                    type="number"
                                                                                    name="collection"
                                                                        ...
                                                                        border-gray-300
                                                                        rounded-md
                                                                        ${touched.collection && errors.collection ? "is-invalid  focus:ring-red-500 focus:border-red-500 " : "focus:ring-green-500 focus:border-gray-500"}`} />
                                                                                <ErrorMessage
                                                                                    component="span"
                                                                                    name="collection"
                                                                                    className="invalid-feedback" />
...
const FormComponentWithRouter = withRouter(CollectionComponent);
